...
#define CUSTOM_MACHINE_NAME "Ender3S1-EZABL"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  17.10  // MRiscoC Stock Ender3S1 PID
    #define DEFAULT_Ki   1.39  // MRiscoC Stock Ender3S1 PID
    #define DEFAULT_Kd  52.79  // MRiscoC Stock Ender3S1 PID
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 54.86  // MRiscoC Stock Ender3S1 PID
  #define DEFAULT_bedKi  10.06  // MRiscoC Stock Ender3S1 PID
  #define DEFAULT_bedKd 199.38  // MRiscoC Stock Ender3S1 PID
...
//#define ENDSTOPPULLUPS  // Ender3S1 Configs
#if DISABLED(ENDSTOPPULLUPS)
  // Disable ENDSTOPPULLUPS to set pullups individually
  //#define ENDSTOPPULLUP_XMIN
  //#define ENDSTOPPULLUP_YMIN
  #define ENDSTOPPULLUP_ZMIN  // Ender3S1 Configs
  ...
  #define ENDSTOPPULLUP_ZMIN_PROBE  // Ender3S1 Configs
#endif
...
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  // MRiscoC EZABL from TH3DStudio
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // Set to true to invert the logic of the probe.  // MRiscoC EZABL from TH3DStudio
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9 }  // Ender3S1 Configs
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 15, 25 }  // Ender3S1 Configs

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2  // MRiscoC allows higher limits
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 20, 200 } // ...or, set your own edit limits  // MRiscoC allows higher limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1000 }  // Ender3S1 Configs
...
#define DEFAULT_RETRACT_ACCELERATION  800    // E acceleration for retracts  // Ender3S1 Configs
...
#define CLASSIC_JERK  // Ender3S1 Configs
  ...
  #define DEFAULT_XJERK 5  // Ender3S1 Configs
  #define DEFAULT_YJERK 5  // Ender3S1 Configs
  #define DEFAULT_ZJERK  0.3  // Ender3S1 Configs
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2  // Ender3S1 Configs
  #if ENABLED(LIMITED_JERK_EDITING)
    #define MAX_JERK_EDIT_VALUES { 20, 20, 1, 20 } // ...or, set your own edit limits  // MRiscoC allows higher limits
  #endif
#endif

#define DEFAULT_EJERK    5.0  // May be used by Linear Advance  // Ender3S1 Configs
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // Ender3S1 Configs  // MRiscoC Probe connected to EZABL port

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  // Ender3S1 Configs  // MRiscoC Probe connected to EZABL port
 ...
 */
#define FIX_MOUNTED_PROBE  // MRiscoC EZABL from TH3DStudio
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }  // Ender3S1 Configs  // MRiscoC EZABL from TH3DStudio

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 3  // MRiscoC for center probing area increase this value
 ...
 */
#define MULTIPLE_PROBING 2  // MRiscoC Enabled  // MRiscoC Enabled
#define EXTRA_PROBING    1  // MRiscoC Enabled  // MRiscoC Enabled
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   3 // Z Clearance for Deploy/Stow  // Ender3S1 Configs  // MRiscoC EZABL from TH3DStudio
#define Z_CLEARANCE_BETWEEN_PROBES  2 // Z Clearance between probe points  // Ender3S1 Configs  // MRiscoC EZABL from TH3DStudio
#define Z_CLEARANCE_MULTI_PROBE     2 // Z Clearance between multiple probes  // Ender3S1 Configs  // EZABL from TH3DStudio
//#define Z_AFTER_PROBING           5 // Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping  // Ender3S1 Configs  // MRiscoC EZABL from TH3DStudio
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // MRiscoC Enable M48 repeatability test  // MRiscoC Enable M48 repeatability test
 ...
 */
#define PROBING_HEATERS_OFF       // Turn heaters off when probing  // MRiscoC Enabled for EZABL version
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes (to improve accuracy)
  //#define WAIT_FOR_HOTEND         // Wait for hotend to heat back up between probes (to improve accuracy & prevent cold extrude)
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing  // MRiscoC Turn fans off for avoid vibrations and interference  // MRiscoC Turn fans off for avoid vibrations and interference
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors  // MRiscoC Wait for stability  // MRiscoC Wait for stability
...
#define Z_HOMING_HEIGHT  5      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...  // MRiscoC Crearance over the bed
...
#define AUTO_BED_LEVELING_BILINEAR  // MRiscoC BLTouch auto level  // MRiscoC EZABL auto level
...
#define PREHEAT_BEFORE_LEVELING  // MRiscoC Heatting to compensate thermal expansions  // Ender3S1 Configs
  ...
  #define LEVELING_NOZZLE_TEMP     0   // (°C) Only applies to E0 at this time  // MRiscoC No necessary for BLTouch  // MRiscoC No necessary for EZABL
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4  // MRiscoC Customizable by menu
 ...
 */
#define Z_SAFE_HOMING  // MRiscoC Homing Z at center of bed  // MRiscoC Homing Z at center of bed
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 2), (Y_MAX_POS - 2), 20 }  // MRiscoC Customizable by menu
