...
#define BABYSTEPPING  // Ender Configs
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  // MRiscoC Enabled for EZABL version
 ...
 */
#define G29_RETRY_AND_RECOVER  // MRiscoC Enabled for EZABL version
