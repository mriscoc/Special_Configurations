...
#define CUSTOM_MACHINE_NAME "Ender3v2 422 AutoLev"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25 }  // Ender3v2 Configs
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // MRiscoC Probe connected to AutoLev port

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  // MRiscoC Probe connected to AutoLev port
 ...
 */
#define FIX_MOUNTED_PROBE  // MRiscoC AutoLev from Substancia3D
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }  // MRiscoC AutoLev from Substancia3D
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   3 // Z Clearance for Deploy/Stow  // MRiscoC AutoLev from Substancia3D
#define Z_CLEARANCE_BETWEEN_PROBES  2 // Z Clearance between probe points  // MRiscoC AutoLev from Substancia3D
#define Z_CLEARANCE_MULTI_PROBE     2 // Z Clearance between multiple probes  // AutoLev from Substancia3D
//#define Z_AFTER_PROBING           5 // Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping  // MRiscoC AutoLev from Substancia3D
...
#define AUTO_BED_LEVELING_BILINEAR  // MRiscoC AutoLev auto level
...
#define PREHEAT_BEFORE_LEVELING  // MRiscoC Heatting to compensate thermal expansions
  ...
  #define LEVELING_NOZZLE_TEMP   0   // (°C) Only applies to E0 at this time  // MRiscoC No necessary for AutoLev
