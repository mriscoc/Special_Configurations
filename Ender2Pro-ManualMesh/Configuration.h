...
#define BED_MAXTEMP      90  // Ender2Pro Configs
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  10.30
    #define DEFAULT_Ki   0.53
    #define DEFAULT_Kd  49.80
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 92.60 }  // Ender Configs
...
#define CLASSIC_JERK  // Ender Configs
  ...
  #define DEFAULT_XJERK 6.0  // Ender Configs
  #define DEFAULT_YJERK 6.0  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }  // Manual mesh use the nozzle as probe
