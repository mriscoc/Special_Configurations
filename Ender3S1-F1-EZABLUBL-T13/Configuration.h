...
#define CUSTOM_MACHINE_NAME "Ender3S1-F1-EZABLUBL-T13"
...
#define HEATER_0_MINTEMP   5  // Ender Configs  // 100k Hisens 3950 1% up to 300°C
...
#define HEATER_0_MAXTEMP 300  // 100k Hisens 3950 1% up to 300°C
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  17.10  // MRiscoC Stock PID
    #define DEFAULT_Ki   1.39  // MRiscoC Stock PID
    #define DEFAULT_Kd  52.79  // MRiscoC Stock PID
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 54.86  // MRiscoC Stock PID
  #define DEFAULT_bedKi 10.06  // MRiscoC Stock PID
  #define DEFAULT_bedKd 199.38  // MRiscoC Stock PID
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // Probe connected to Z min endstop port
...
//#define AUTO_BED_LEVELING_BILINEAR  // MRiscoC EZABL auto level  // Disabled for UBL
