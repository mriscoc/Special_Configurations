...
#define CUSTOM_MACHINE_NAME "Ender3V2-427BLT-NEOGRB"
...
#define NEOPIXEL_LED  // Adafruit Neopixels
#if ENABLED(NEOPIXEL_LED)
  #define NEOPIXEL_TYPE   NEO_GRB  // Adafruit Neopixels
  #define NEOPIXEL_PIN     PA14  // Adafruit Neopixels
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS 15       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)  // Adafruit Neopixels
  #define NEOPIXEL_IS_SEQUENTIAL   // Sequential display for temperature change - LED by LED. Disable to change all LEDs at once.
  #define NEOPIXEL_BRIGHTNESS 127  // Initial brightness (0-255)
  #define NEOPIXEL_STARTUP_TEST  // Cycle through colors at startup  // Adafruit Neopixels
